        ...
        build: (ctx) => pw.Column(
          ...
          children: [
            ...
            pw.Text(
              ...
              style: pw.TextStyle(font: fontRegular, fontSize: 11, lineSpacing: 3.5, color: PdfColors.black),
            ),
            pw.SizedBox(height: 14),
            pw.Container(
            ...
            pw.Text(
              ...
              style: pw.TextStyle(font: fontRegular, fontSize: 9, color: PdfColors.black, fontStyle: pw.FontStyle.italic),
            ),
            pw.Spacer(),
    ...
    return pw.Padding(
      ...
      child: pw.Row(
        ...
        children: [
          ...
          pw.Text(':  ', style: pw.TextStyle(fontSize: 11, color: PdfColors.black)),
          pw.Expanded(
            child: pw.Text(
              value,
              style: pw.TextStyle(font: fontValue, fontSize: 11, color: PdfColors.black),
